...
<body onload="ambilPostSejarahDesa()">

<!-- Box for input post content -->
<div class="container" id="container">
<br>
<center><h5>Data Sejarah Desa</h5></center>
	<div class="box">
	<h6>Masukan Sejarah Desa</h6>
		<form >
			<textarea id="content" name="content" class="form-control" 
			placeholder="Write Something..." maxlength="140"></textarea>
			<br>
			<button onclick="buatPostSejarahDesa(this.value);" type="button" style="float:right;" 
